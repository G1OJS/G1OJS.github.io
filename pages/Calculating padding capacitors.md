...
<figure>
  <img src="{{site.baseurl}}/img/Capacitor padding circuit 1.png" alt="Variable capacitor in parallel with C1 and this in series with C2"/>
  <figcaption>Configuration a)</figcaption>
</figure>

<figure>
  <img src="{{site.baseurl}}/img/Capacitor padding circuit 2.png" alt="Variable capacitor in series with C1 and this in parallel with C2"/>
